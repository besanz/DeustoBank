...
void enviarMenuDepositar(SOCKET ClientSocket){
    send(ClientSocket, (char *)"Ingrese la cantidad que quiere depositar con el siguiente formato: 231;cantidad; \n",strlen((char *)"Ingrese la cantidad que quiere depositar con el siguiente formato:231;cantidad; \n"), 0);
}
